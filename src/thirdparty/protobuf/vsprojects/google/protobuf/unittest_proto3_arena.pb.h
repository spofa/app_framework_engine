...
class TestPackedTypes : public ::google::protobuf::Message {
 public:
  ...
  inline ::proto3_arena_unittest::ForeignEnum packed_enum(int index) const;
  inline void set_packed_enum(int index, ::proto3_arena_unittest::ForeignEnum value);
  inline void add_packed_enum(::proto3_arena_unittest::ForeignEnum value);
...
class NestedTestAllTypes : public ::google::protobuf::Message {
 public:
  ...
  inline const ::proto3_arena_unittest::NestedTestAllTypes& child() const;
  inline ::proto3_arena_unittest::NestedTestAllTypes* mutable_child();
  inline ::proto3_arena_unittest::NestedTestAllTypes* release_child();
  inline void set_allocated_child(::proto3_arena_unittest::NestedTestAllTypes* child);
  inline ::proto3_arena_unittest::NestedTestAllTypes* unsafe_arena_release_child();
  ...
  inline const ::proto3_arena_unittest::TestAllTypes& payload() const;
  inline ::proto3_arena_unittest::TestAllTypes* mutable_payload();
  inline ::proto3_arena_unittest::TestAllTypes* release_payload();
  inline void set_allocated_payload(::proto3_arena_unittest::TestAllTypes* payload);
  inline ::proto3_arena_unittest::TestAllTypes* unsafe_arena_release_payload();
