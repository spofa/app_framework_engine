...
#define ZR_(first, last) do {                              \
  ...
  optional_foreign_message_ = NULL;
  if (optional_proto2_message_ != NULL) delete optional_proto2_message_;
  optional_proto2_message_ = NULL;
  optional_nested_enum_ = 0;
  optional_foreign_enum_ = 0;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 49: {
        ...
        if (input->ExpectTag(394)) goto parse_repeated_foreign_message;
        if (input->ExpectTag(402)) goto parse_repeated_proto2_message;
        break;
      }
...
void TestProto2Required::Clear() {
  if (proto2_ != NULL) delete proto2_;
  proto2_ = NULL;
}
...
void TestProto2Required::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const TestProto2Required* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TestProto2Required*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
