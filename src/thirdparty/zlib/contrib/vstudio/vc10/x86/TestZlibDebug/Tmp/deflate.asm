...
tv286 = -108						; size = 4
tv190 = -108						; size = 4
_bstate$80744 = -40					; size = 4
_val$80720 = -36					; size = 4
_beg$80719 = -32					; size = 4
_val$80707 = -28					; size = 4
_beg$80706 = -24					; size = 4
_beg$80694 = -20					; size = 4
_level_flags$80680 = -16				; size = 4
_header$80679 = -12					; size = 4
_s$ = -8						; size = 4
_old_flush$ = -4					; size = 4
_strm$ = 8						; size = 4
_flush$ = 12						; size = 4
...
; 738  :             uInt header = (Z_DEFLATED + ((s->w_bits-8)<<4)) << 8;
	...
	add	ecx, 8
	shl	ecx, 8
	mov	DWORD PTR _header$80679[ebp], ecx
...
; 742  :                 level_flags = 0;
	...
	mov	DWORD PTR _level_flags$80680[ebp], 0
...
; 744  :                 level_flags = 1;
	...
	mov	DWORD PTR _level_flags$80680[ebp], 1
	jmp	SHORT $LN68@deflate
$LN67@deflate:
...
; 746  :                 level_flags = 2;
	...
	mov	DWORD PTR _level_flags$80680[ebp], 2
...
; 748  :                 level_flags = 3;
	...
	mov	DWORD PTR _level_flags$80680[ebp], 3
$LN68@deflate:

; 749  :             header |= (level_flags << 6);

	mov	eax, DWORD PTR _level_flags$80680[ebp]
	shl	eax, 6
	or	eax, DWORD PTR _header$80679[ebp]
	mov	DWORD PTR _header$80679[ebp], eax
...
; 750  :             if (s->strstart != 0) header |= PRESET_DICT;
	...
	mov	eax, DWORD PTR _header$80679[ebp]
	or	eax, 32					; 00000020H
	mov	DWORD PTR _header$80679[ebp], eax
$LN63@deflate:
...
; 751  :             header += 31 - (header % 31);
	...
	sub	eax, edx
	add	eax, DWORD PTR _header$80679[ebp]
	mov	DWORD PTR _header$80679[ebp], eax
...
; 767  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80694[ebp], ecx
$LN59@deflate:
...
; 771  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80694[ebp]
...
; 773  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80694[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80694[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 795  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80706[ebp], ecx
$LN49@deflate:
...
; 800  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80706[ebp]
...
; 802  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80706[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80706[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 806  :                         val = 1;
	...
	mov	DWORD PTR _val$80707[ebp], 1
...
; 810  :                 val = s->gzhead->name[s->gzindex++];
	...
	mov	DWORD PTR _val$80707[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 811  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$80707[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 812  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80707[ebp], 0
	jne	$LN49@deflate
$LN47@deflate:
...
; 826  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80719[ebp], ecx
$LN38@deflate:
...
; 831  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80719[ebp]
...
; 833  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80719[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80719[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 837  :                         val = 1;
	...
	mov	DWORD PTR _val$80720[ebp], 1
...
; 841  :                 val = s->gzhead->comment[s->gzindex++];
	...
	mov	ecx, DWORD PTR [eax+32]
	movzx	edx, BYTE PTR [edx+ecx]
	mov	DWORD PTR _val$80720[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 842  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$80720[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 843  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80720[ebp], 0
	jne	$LN38@deflate
$LN36@deflate:
...
$LN97@deflate:
	...
	mov	DWORD PTR _bstate$80744[ebp], eax

; 906  : 
; 907  :         if (bstate == finish_started || bstate == finish_done) {

	cmp	DWORD PTR _bstate$80744[ebp], 2
	je	SHORT $LN16@deflate
	cmp	DWORD PTR _bstate$80744[ebp], 3
...
; 910  :         if (bstate == need_more || bstate == finish_started) {
	...
	cmp	DWORD PTR _bstate$80744[ebp], 0
...
; 923  :         if (bstate == block_done) {
	...
	cmp	DWORD PTR _bstate$80744[ebp], 1
	jne	$LN19@deflate
...
tv149 = -100						; size = 4
tv138 = -100						; size = 4
_init$80892 = -32					; size = 4
_curr$80890 = -28					; size = 4
_str$80882 = -24					; size = 4
_wsize$ = -20						; size = 4
_more$ = -16						; size = 4
_p$ = -12						; size = 4
_m$ = -8						; size = 4
...
; 1472 :             uInt str = s->strstart - s->insert;
	...
	mov	DWORD PTR _str$80882[ebp], edx

; 1473 :             s->ins_h = s->window[str];

	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	edx, DWORD PTR _str$80882[ebp]
...
; 1474 :             UPDATE_HASH(s, s->ins_h, s->window[str + 1]);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	eax, DWORD PTR _str$80882[ebp]
...
; 1481 :                 s->prev[str & s->w_mask] = s->head[s->ins_h];
	...
	mov	eax, DWORD PTR [edx+68]
	mov	edx, DWORD PTR _s$[ebp]
	mov	esi, DWORD PTR _str$80882[ebp]
	and	esi, DWORD PTR [edx+52]
	mov	edx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [edx+64]
	mov	ax, WORD PTR [eax+ecx*2]
...
; 1483 :                 s->head[s->ins_h] = (Pos)str;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+68]
	mov	dx, WORD PTR _str$80882[ebp]
	mov	WORD PTR [eax+ecx*2], dx
...
; 1484 :                 str++;
	...
	mov	eax, DWORD PTR _str$80882[ebp]
	add	eax, 1
	mov	DWORD PTR _str$80882[ebp], eax
...
; 1504 :         ulg curr = s->strstart + (ulg)(s->lookahead);
	...
	mov	edx, DWORD PTR _s$[ebp]
	add	ecx, DWORD PTR [edx+116]
	mov	DWORD PTR _curr$80890[ebp], ecx
...
; 1507 :         if (s->high_water < curr) {
	...
	cmp	ecx, DWORD PTR _curr$80890[ebp]
...
; 1511 :             init = s->window_size - curr;
	...
	sub	ecx, DWORD PTR _curr$80890[ebp]
	mov	DWORD PTR _init$80892[ebp], ecx

; 1512 :             if (init > WIN_INIT)

	cmp	DWORD PTR _init$80892[ebp], 258		; 00000102H
	jbe	SHORT $LN4@fill_windo

; 1513 :                 init = WIN_INIT;

	mov	DWORD PTR _init$80892[ebp], 258		; 00000102H
$LN4@fill_windo:

; 1514 :             zmemzero(s->window + curr, (unsigned)init);

	mov	eax, DWORD PTR _init$80892[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+56]
	add	edx, DWORD PTR _curr$80890[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 1515 :             s->high_water = curr + init;
	...
	mov	eax, DWORD PTR _curr$80890[ebp]
	add	eax, DWORD PTR _init$80892[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
; 1522 :             init = (ulg)curr + WIN_INIT - s->high_water;
	...
	mov	DWORD PTR _init$80892[ebp], eax
...
; 1523 :             if (init > s->window_size - s->high_water)
	...
	cmp	DWORD PTR _init$80892[ebp], edx
...
; 1524 :                 init = s->window_size - s->high_water;
	...
	mov	edx, DWORD PTR [eax+60]
	sub	edx, DWORD PTR [ecx+5824]
	mov	DWORD PTR _init$80892[ebp], edx
$LN1@fill_windo:
...
; 1526 :             s->high_water += init;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5824]
	add	ecx, DWORD PTR _init$80892[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 1672 :                            s->match_length - MIN_MATCH, bflush);
	...
	mov	ax, WORD PTR _dist$80966[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$80966[ebp], ax
	movzx	eax, BYTE PTR _len$80965[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$80965[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$80966[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN23@deflate_fa
	movzx	ecx, WORD PTR _dist$80966[ebp]
...
; 1708 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$80974[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
_cc$81041 = -22						; size = 1
_cc$81031 = -21						; size = 1
_dist$81016 = -20					; size = 2
_len$81015 = -13					; size = 1
_max_insert$81014 = -12					; size = 4
_bflush$ = -8						; size = 4
_hash_head$ = -4					; size = 4
_s$ = 8							; size = 4
_flush$ = 12						; size = 4
...
; 1791 :             uInt max_insert = s->strstart + s->lookahead - MIN_MATCH;
	...
	mov	DWORD PTR _max_insert$81014[ebp], ecx
...
; 1797 :                            s->prev_length - MIN_MATCH, bflush);
	...
	sub	ecx, 3
	mov	BYTE PTR _len$81015[ebp], cl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+108]
	sub	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	sub	ecx, DWORD PTR [edx+100]
	mov	WORD PTR _dist$81016[ebp], cx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$81016[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$81015[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$81016[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$81016[ebp], ax
	movzx	eax, BYTE PTR _len$81015[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81015[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$81016[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN29@deflate_sl
	movzx	ecx, WORD PTR _dist$81016[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1807 :                 if (++s->strstart <= max_insert) {
	...
	cmp	ecx, DWORD PTR _max_insert$81014[ebp]
	ja	$LN15@deflate_sl
...
; 1823 :             _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81031[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81031[ebp]
...
; 1842 :         _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81041[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81041[ebp]
...
tv210 = -96						; size = 4
_cc$81082 = -25						; size = 1
_dist$81080 = -24					; size = 2
_len$81079 = -17					; size = 1
_strend$ = -16						; size = 4
_scan$ = -12						; size = 4
_prev$ = -8						; size = 4
_bflush$ = -4						; size = 4
...
; 1906 :             _tr_tally_dist(s, 1, s->match_length - MIN_MATCH, bflush);
	...
	mov	ecx, DWORD PTR [eax+96]
	sub	ecx, 3
	mov	BYTE PTR _len$81079[ebp], cl
	mov	eax, 1
	mov	WORD PTR _dist$81080[ebp], ax
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$81080[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$81079[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$81080[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$81080[ebp], ax
	movzx	eax, BYTE PTR _len$81079[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81079[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$81080[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN23@deflate_rl
	movzx	ecx, WORD PTR _dist$81080[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1914 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81082[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81082[ebp]
...
; 1954 :         _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81115[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81115[ebp]
