; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\yyh\Downloads\zlib-1.2.8\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\yyh\downloads\zlib-1.2.8\zlib-1.2.8\contrib\testzlib\testzlib.c
;	COMDAT _MyDoMinus64
_TEXT	SEGMENT
_R$ = 8							; size = 4
_A$ = 12						; size = 8
...
tv226 = -300						; size = 4
tv141 = -300						; size = 4
_all_read_before$81955 = -232				; size = 4
_step$81948 = -228					; size = 4
_lOrigDone$81947 = -224					; size = 4
_lOrigToDo$81946 = -220					; size = 4
_ret$81945 = -216					; size = 4
_zcpr$81944 = -212					; size = 56
_all_read_before$81935 = -156				; size = 4
_step$81927 = -152					; size = 4
_lOrigDone$81926 = -148					; size = 4
_lOrigToDo$81925 = -144					; size = 4
_ret$81924 = -140					; size = 4
_zcpr$81923 = -136					; size = 56
...
; 193  :         int ret=Z_OK;
	...
	mov	DWORD PTR _ret$81924[ebp], 0

; 194  :         long lOrigToDo = lFileSize;

	mov	eax, DWORD PTR _lFileSize$[ebp]
	mov	DWORD PTR _lOrigToDo$81925[ebp], eax

; 195  :         long lOrigDone = 0;

	mov	DWORD PTR _lOrigDone$81926[ebp], 0

; 196  :         int step=0;

	mov	DWORD PTR _step$81927[ebp], 0

; 197  :         memset(&zcpr,0,sizeof(z_stream));

	push	56					; 00000038H
	push	0
	lea	eax, DWORD PTR _zcpr$81923[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 198  :         deflateInit(&zcpr,cprLevel);
	...
	push	eax
	lea	ecx, DWORD PTR _zcpr$81923[ebp]
	push	ecx
...
; 200  :         zcpr.next_in = FilePtr;
	...
	mov	DWORD PTR _zcpr$81923[ebp], eax

; 201  :         zcpr.next_out = CprPtr;

	mov	eax, DWORD PTR _CprPtr$[ebp]
	mov	DWORD PTR _zcpr$81923[ebp+12], eax
$LN8@main:
...
; 206  :             long all_read_before = zcpr.total_in;
	...
	mov	eax, DWORD PTR _zcpr$81923[ebp+8]
	mov	DWORD PTR _all_read_before$81935[ebp], eax

; 207  :             zcpr.avail_in = min(lOrigToDo,BlockSizeCompress);

	mov	eax, DWORD PTR _lOrigToDo$81925[ebp]
	cmp	eax, DWORD PTR _BlockSizeCompress$[ebp]
	jge	SHORT $LN17@main
	mov	ecx, DWORD PTR _lOrigToDo$81925[ebp]
...
$LN18@main:
	...
	mov	DWORD PTR _zcpr$81923[ebp+4], eax

; 208  :             zcpr.avail_out = BlockSizeCompress;

	mov	eax, DWORD PTR _BlockSizeCompress$[ebp]
	mov	DWORD PTR _zcpr$81923[ebp+16], eax

; 209  :             ret=deflate(&zcpr,(zcpr.avail_in==lOrigToDo) ? Z_FINISH : Z_SYNC_FLUSH);

	mov	eax, DWORD PTR _zcpr$81923[ebp+4]
	xor	ecx, ecx
	cmp	eax, DWORD PTR _lOrigToDo$81925[ebp]
	sete	cl
	lea	ecx, DWORD PTR [ecx+ecx+2]
	push	ecx
	lea	edx, DWORD PTR _zcpr$81923[ebp]
	push	edx
	call	_deflate@8
	mov	DWORD PTR _ret$81924[ebp], eax

; 210  :             lOrigDone += (zcpr.total_in-all_read_before);

	mov	eax, DWORD PTR _zcpr$81923[ebp+8]
	sub	eax, DWORD PTR _all_read_before$81935[ebp]
	add	eax, DWORD PTR _lOrigDone$81926[ebp]
	mov	DWORD PTR _lOrigDone$81926[ebp], eax
...
; 211  :             lOrigToDo -= (zcpr.total_in-all_read_before);
	...
	mov	ecx, DWORD PTR _lOrigToDo$81925[ebp]
	sub	ecx, eax
	mov	DWORD PTR _lOrigToDo$81925[ebp], ecx

; 212  :             step++;

	mov	eax, DWORD PTR _step$81927[ebp]
	add	eax, 1
	mov	DWORD PTR _step$81927[ebp], eax

; 213  :         } while (ret==Z_OK);

	cmp	DWORD PTR _ret$81924[ebp], 0
	je	$LN8@main

; 214  : 
; 215  :         lSizeCpr=zcpr.total_out;

	mov	eax, DWORD PTR _zcpr$81923[ebp+20]
...
; 234  :         int ret=Z_OK;
	...
	mov	DWORD PTR _ret$81945[ebp], 0

; 235  :         long lOrigToDo = lSizeCpr;

	mov	eax, DWORD PTR _lSizeCpr$[ebp]
	mov	DWORD PTR _lOrigToDo$81946[ebp], eax

; 236  :         long lOrigDone = 0;

	mov	DWORD PTR _lOrigDone$81947[ebp], 0

; 237  :         int step=0;

	mov	DWORD PTR _step$81948[ebp], 0

; 238  :         memset(&zcpr,0,sizeof(z_stream));

	push	56					; 00000038H
	push	0
	lea	eax, DWORD PTR _zcpr$81944[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 241  :         zcpr.next_in = CprPtr;
	...
	mov	eax, DWORD PTR _CprPtr$[ebp]
	mov	DWORD PTR _zcpr$81944[ebp], eax

; 242  :         zcpr.next_out = UncprPtr;

	mov	eax, DWORD PTR _UncprPtr$[ebp]
	mov	DWORD PTR _zcpr$81944[ebp+12], eax
$LN5@main:
...
; 247  :             long all_read_before = zcpr.total_in;
	...
	mov	eax, DWORD PTR _zcpr$81944[ebp+8]
	mov	DWORD PTR _all_read_before$81955[ebp], eax

; 248  :             zcpr.avail_in = min(lOrigToDo,BlockSizeUncompress);

	mov	eax, DWORD PTR _lOrigToDo$81946[ebp]
	cmp	eax, DWORD PTR _BlockSizeUncompress$[ebp]
	jge	SHORT $LN19@main
	mov	ecx, DWORD PTR _lOrigToDo$81946[ebp]
...
; 250  :             ret=inflate(&zcpr,Z_SYNC_FLUSH);
	...
	push	eax
	call	_inflate@8
	mov	DWORD PTR _ret$81945[ebp], eax

; 251  :             lOrigDone += (zcpr.total_in-all_read_before);

	mov	eax, DWORD PTR _zcpr$81944[ebp+8]
	sub	eax, DWORD PTR _all_read_before$81955[ebp]
	add	eax, DWORD PTR _lOrigDone$81947[ebp]
	mov	DWORD PTR _lOrigDone$81947[ebp], eax
...
; 252  :             lOrigToDo -= (zcpr.total_in-all_read_before);
	...
	mov	ecx, DWORD PTR _lOrigToDo$81946[ebp]
	sub	ecx, eax
	mov	DWORD PTR _lOrigToDo$81946[ebp], ecx

; 253  :             step++;

	mov	eax, DWORD PTR _step$81948[ebp]
	add	eax, 1
	mov	DWORD PTR _step$81948[ebp], eax

; 254  :         } while (ret==Z_OK);

	cmp	DWORD PTR _ret$81945[ebp], 0
	je	$LN5@main

; 255  : 
; 256  :         lSizeUncpr=zcpr.total_out;

	mov	eax, DWORD PTR _zcpr$81944[ebp+20]
