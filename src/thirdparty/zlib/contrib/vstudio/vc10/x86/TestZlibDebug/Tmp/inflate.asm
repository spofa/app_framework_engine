...
; 190  :         stream_size != (int)(sizeof(z_stream)))
	...
	movsx	edx, BYTE PTR ??_C@_05IAIEPMAK@1?42?48?$AA@
	cmp	ecx, edx
...
$LN510@inflate:
	mov	DWORD PTR tv1325[ebp], 256		; 00000100H
$LN511@inflate:
	mov	edx, DWORD PTR _state$[ebp]
...
; 1333 :     if (strm == Z_NULL || strm->state == Z_NULL) return Z_STREAM_ERROR;
	...
	cmp	DWORD PTR _strm$[ebp], 0
	je	SHORT $LN2@inflateGet@2
	mov	eax, DWORD PTR _strm$[ebp]
	cmp	DWORD PTR [eax+28], 0
	jne	SHORT $LN3@inflateGet@2
$LN2@inflateGet@2:
	mov	eax, -2					; fffffffeH
	jmp	SHORT $LN4@inflateGet@2
$LN3@inflateGet@2:
